...
interface SocialMediaAnalysisModalProps {
  open: boolean;
...
export const SocialMediaAnalysisModal = ({ open, onOpenChange }: SocialMediaAnalysisModalProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Conecta tus perfiles de redes sociales para que la IA pueda analizar tu actividad y proporcionarte mejor contexto personalizado
          </DialogDescription>
        </DialogHeader>
